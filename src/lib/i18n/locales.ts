...
const en: Dict = {
  ...
  correction: {
    cta: "Report an error",
    dialogTitle: "Report an error",
    dialogDesc:
      "Help us improve this page. Your report is reviewed manually and never edits the page automatically.",
    typeLabel: "Error type",
    detailsLabel: "Details",
    detailsPlaceholder:
      "Describe the error (e.g. the poster is wrong, platform X is missing…).",
    charsRemaining: "{count} characters left",
    yourReports: "Your reports on this page",
    emptyBody: "Briefly describe the issue.",
    sent: "Report sent. Thanks! The KAZEN team will review it.",
    rateLimit: "Too many recent reports. Try again in a moment.",
    duplicate: "You already have an open report of this type on this page.",
    sendFailed: "Couldn't send the report right now.",
  },
  mediaRequest: {
    cta: "Suggest this title",
    dialogTitle: "Suggest a missing title",
    dialogDesc:
      "This title isn't in KAZEN yet? Suggest it. The KAZEN team will review it — it doesn't create a page automatically.",
    titlePlaceholder: "Media title",
    urlPlaceholder: "External link (optional) — e.g. AniList, TMDB…",
    notePlaceholder: "Why this title? (optional)",
    submit: "Send suggestion",
    emptyTitle: "Enter the title to suggest.",
    sent: "Suggestion sent. Thanks! The KAZEN team will review it.",
    sendFailed: "Couldn't send the suggestion right now.",
  },
  reco: {
    triggerLabel: "Assistant",
    title: "What do you want to watch?",
    description:
      "Describe a mood — genre, type, vibe — and I'll suggest the most relevant titles.",
    inputPlaceholder: "e.g. a recent horror anime",
    inputAria: "Describe what you want to watch",
    find: "Find",
    preparing: "Preparing recommendations…",
    selectionFor: "Selection for:",
    noMatch: "No title matches exactly.",
    noMatchHint: "Try a different wording, genre or type.",
    promptEmpty: "Ask a question to get started.",
    promptEmptyHint: "Tip: combine type + genre + mood, e.g. \"recent thriller series\".",
  },
  playlist: {
    myPlaylists: "My playlists",
