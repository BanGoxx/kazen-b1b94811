...
export const PROVIDERS: ProviderDef[] = [
  ...
  },
  {
    ...
    notes: [
      ...
      "Ces champs (progression, dates, visionnages, notes, tags) sont appliqués à ta liste lors de la confirmation, sans jamais écraser une valeur que tu as déjà renseignée.",
      "Limite : seules les listes d'anime sont gérées (pas les mangas). Les titres sont rapprochés du catalogue KAZEN par correspondance de nom ; vérifie l'aperçu avant de confirmer.",
    ],
